@section('meta-content')
  <title>{{ ucfirst(config('app.name', 'Laravel')) }} | Policy</title>
  ...
  <meta property="og:title" content="{{ ucfirst(config('app.name', 'Laravel')) }} | Policy" />
  <meta property="og:description"
    content="{{ ucfirst(config('app.name', 'Laravel')) }} is an web application to record and track your trading." />
  <meta property="og:image" content="{{ asset('images/logo.png') }}" />
  <meta property="og:url" content="{{ route('user.policy.show') }}" />
  <meta property="og:site_name" content="{{ ucfirst(config('app.name', 'Laravel')) }} | Policy" />
  <meta name="twitter:title" content="{{ ucfirst(config('app.name', 'Laravel')) }} | Policy">
