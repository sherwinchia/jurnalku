<div>
    ...
    <div class="flex flex-col flex-wrap space-y-4 lg:flex-row lg:space-x-4 lg:space-y-0">
        ...
        <x-ui.card class="flex flex-col overflow-hidden bg-primary-100 w-96 h-60">
            <a class="flex-1" href="{{ route('user.portfolios.show', $portfolio->id) }}">
            ...
            <div class="flex justify-end p-2 mt-auto text-gray-700 bg-gray-50">
